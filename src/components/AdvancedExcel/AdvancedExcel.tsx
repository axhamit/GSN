  ...
  const features = [
    {
      icon: <TableChartIcon />,
      title: 'Pivot Tables',
      description: 'Master data summarization and analysis with powerful pivot table techniques.',
      color: 'primary',
    },
    {
      icon: <DashboardIcon />,
      title: 'Dynamic Dashboards',
      description: 'Create interactive dashboards that visualize data and drive decision-making.',
      color: 'secondary',
    },
    {
      icon: <SearchIcon />,
      title: 'XLOOKUP & VLOOKUP',
      description: 'Advanced lookup functions to find and retrieve data across large datasets.',
      color: 'warning',
    },
    {
      icon: <MemoryIcon />,
      title: 'AI in Excel',
      description: 'Leverage artificial intelligence capabilities to automate data analysis and insights.',
      color: 'success',
    },
  ]
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Box sx={{ mt: 3, maxWidth: 700, mx: 'auto' }}>
            ...
            >
              Data is the lifeblood of modern business. Our Advanced Excel module transforms students 
              from basic users to data-proficient analysts ready for MIS and reporting roles.
            </Typography>
          </Box>
        </Box>
